    ...
    : DbContext(options)
{
    ...
    override protected void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<User>()
                    ...
                    .HasValue<UserModel>(RoleType.Student.ToString())
                    .HasValue<UserModel>(RoleType.Tutor.ToString())
                    .HasValue<UserModel>(RoleType.CampaignManager.ToString())
                    .HasValue<UserModel>(RoleType.CampaignJudge.ToString());
