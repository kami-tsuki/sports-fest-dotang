...
import {TeamService, Team} from '@app/services/team.service';
...
export class TopClassComponent {
    ...
    allDisciplines: Discipline[] = [
        {
            name: 'Discipline A', teams: [], judges: [], created: new Date(), updated: new Date(), init: () => {
            }, toJSON: () => ({})
        },
        {
            name: 'Discipline B', teams: [], judges: [], created: new Date(), updated: new Date(), init: () => {
            }, toJSON: () => ({})
        },
    ];
